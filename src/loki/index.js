...
loki.web = {
  ...
  resourceUrl(resourceUrn, options, notUsed3) {
    if (options === null || typeof options === "string") {
      console.log(
        "loki.web.resourceUrl(resourceUrn, queryParams, download) is deprecated, please use loki.web.resourceUrl(resourceUrn,options)"
      );
      options = {
        queryParams: options,
        download: notUsed3,
  ...
  resourceUrlWithCacheCheck(resourceUrn, options, notUsed3) {
    if (options === null || typeof options === "string") {
      console.log(
        "loki.web.resourceUrlWithCacheCheck(resourceUrn, queryParams, download) is deprecated, please use loki.web.resourceUrlWithCacheCheck(resourceUrn,options)"
      );
      options = {
        queryParams: options,
        download: notUsed3,
  ...
  resourceUrlwithCacheCheck(resourceUrn, queryParams, download) {
    console.log(
      "loki.web.resourceUrlwithCacheCheck() is deprecated, please use loki.web.resourceUrlWithCacheCheck() instead"
    );
  ...
  pageUrl(pageUrn, options, notUsed3, notUsed4) {
    if (options === null || typeof options === "string") {
      console.log(
        "loki.web.pageUrl(subjectUrn,pageUrn,queryParams,urlPrefix) is deprecated, please use loki.web.pageUrl(pageUrn,options)"
      );
  ...
  pageUrlWithCacheCheck(pageUrn, options, notUsed3, notUsed4) {
    if (options === null || typeof options === "string") {
      console.log(
        "loki.web.pageUrlWithCacheCheck(subjectUrn,pageUrn,queryParams,urlPrefix) is deprecated, please use loki.web.pageUrlWithCacheCheck(pageUrn,options)"
      );
      const param1 = pageUrn;
      const param2 = options;
      pageUrn = param2;
  ...
  pageUrlwithCacheCheck(subjectUrn, pageUrn, queryParams, prefix) {
    console.log(
      "loki.pageUrlwithCacheCheck() is deprecated, please use loki.pageUrlWithCacheCheck() instead"
    );
  ...
  webServiceUrl(serviceUrn, options, notUsed3, notUsed4) {
    if (options === null || typeof options === "string") {
      console.log(
        "loki.web.webServiceUrl(subjectUrn,serviceUrn,queryParams,urlPrefix) is deprecated, please use loki.web.webServiceUrl(serviceUrn,options)"
      );
...
loki.app = {
  ...
  getReleaseTierUrn() {
    console.log(
      "loki.app.getReleaseTierUrn() is deprecated, please use loki.app.isDebug() instead."
    );
...
loki.environ = {
  ...
  addConnection(connection) {
    console.log(
      "loki.environ.addConnection() is deprecated, please use loki.model.addConnection() instead."
    );
    if (connection) {
      loki.environ._connections.push(connection);
    }
  ...
  getConnection(serviceGroupUrn) {
    console.log(
      "loki.environ.getConnection() is deprecated, please use loki.model.getConnectionByServiceGroup() instead."
    );
...
loki.uploadUrl = function(a, b, c, d, e, f) {
  console.log(
    "loki.uploadUrl() is deprecated, please use loki.web.uploadUrl()."
  );
  return loki.web.uploadUrl(a, b, c, d, e, f);
};
loki.importUrl = function(a, b, c, d, e, f) {
  console.log(
    "loki.importUrl() is deprecated, please use loki.web.importUrl()."
  );
  return loki.web.importUrl(a, b, c, d, e, f);
};
loki.webServiceUrl = function(a, b, c, d, e, f) {
  console.log(
    "loki.webServiceUrl() is deprecated, please use loki.web.webServiceUrl()."
  );
...
loki.getKnownChildren = function(a, b, c, d, e, f) {
  console.log(
    "loki.getKnownChildren() is deprecated, please use loki.data.list()."
  );
  return loki.data.list(a, b, c, d, e, f);
};
...
loki.getUrnLastSegment = function(urn) {
  console.log(
    "loki.getUrnLastSegment() is deprecated, please use loki.urn.getLastSegment()."
  );
...
loki.app.domainUrn =
  loki.user.authRootUrns.length > 0 ? loki.user.authRootUrns[0] : null;
...
loki.data.deleteEntity = function(urn, options, unused1) {
  if (arguments.length > 2 || typeof options === "string") {
    ...
    console.log(
      "loki.data.deleteEntity(urn,view,options) is deprecated, please use loki.data.deleteEntity(urn, options)"
    );
    options = unused1 || {};
  } else {
    options = options || {};
...
loki.data.query = function(options, unused) {
  if (typeof options === "string") {
    ...
    console.log(
      "loki.data.query(queryUrn,options) is deprecated, please use loki.data.query(options) where one option is 'queryUrn'."
    );
  ...
  if (options.engine && !options.dataSpaceUrn) {
    ...
    console.log(
      "The options.query param is deprecated fro loki.data.query(). Use options.dataSpaceUrn instead."
    );
  }
