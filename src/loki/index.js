...
loki.web = {
  ...
  importUrl(sourceUrn, destUrn, viewUrn, options) {
    ...
    const apiPrefix = loki.web.getApiServicePrefix();
    let url = `${apiPrefix
    }urn/com/loki/importData/model/api/importData/v/${
      destPath
    }?source=${
      sourceUrn}`;
...
loki.imageUrl = function (a, b, c, d, e, f) {
  console.log(
    "loki.imageUrl() is deprecated, please use loki.web.imageUrl().",
  );
...
loki.isNewUrn = function (a, b, c, d, e, f) {
  console.log(
    "loki.isNewUrn() is deprecated, please use loki.urn.isNewUrn().",
  );
