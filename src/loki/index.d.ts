...
export type QueryOptions<Opts = BaseQueryOptions> = Pick<Opts, "queryUrn"> extends {queryUrn: string} ? Omit<BaseQueryOptions, "query"> : Omit<BaseQueryOptions, "queryUrn">;
...
export type QueryResponse<Type, Opts = QueryOptions> = Pick<Opts, "mapResults"> extends { mapResults: undefined } ? Promise<QueryResponseUnmapped<Type>> : Promise<QueryResponseMapped<Type>>;
